...
- 🔴 **THE SHIP CHECK -- MECHANICAL, RUN IT BEFORE EVERY COMMIT. Added 2026-08-05 because "keep the docs
  ...
  | **Anything about free vs paid** (a gate, a perk, a price, a tier, a tip) | **`SPEC_monetization.md`** -- 🔴 **ADDED 2026-08-09 AFTER AN AUDIT FOUND IT WAS THE ONLY FILE NOBODY WAS REQUIRED TO CHECK, AND IT HAD DRIFTED FURTHEST.** It still priced the app at $6.99/$69.99 in twelve places (real: $9.99/$89.99 since 2026-07-28), still said AI voicing was "NOT BUILT" and that "free users still get voicing" two days after it shipped, and had never heard of the Otto coach gate, which is the biggest free-tier change the project has made. **Every other doc in this table was accurate.** A file that defines the product but sits outside the check is the one that rots. |
