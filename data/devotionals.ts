...
const REST_AND_RECOVERY_DAYS: DevotionalDay[] = [
  ...
  },
  {
    ...
    reflection:
      ...
      'Jesus’ response is the surprising part. He does not praise them for skipping meals or tell them the work is too important to pause. He tells them to slip away together, somewhere quiet, and rest for a while. Then they actually leave, get in a boat, and go. The Son of God, with endless needs pressing in around him, builds a deliberate stop into the middle of the mission. He treats rest as part of the work, not a betrayal of it.\n\n' +
...
const SEXUAL_INTEGRITY_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      'Few areas of life carry as much hidden shame as this one. People hide it, white-knuckle it, swear it off on Monday and break by Thursday, and carry a quiet sense that God is mostly disappointed in them. Paul opens this chapter by cutting straight through all of that: if you belong to Christ, the verdict against you has already been lifted.\n\n' +
      'Notice he does not say there is no struggle, or no failure, or no growth left to do. He says no condemnation. The verdict over your life was already settled, and it was settled at the cross, not by your last clean streak. The very next line tells you why: what the Spirit of life has done in Christ has broken the grip sin and death used to hold over you. Freedom here is not a reward you earn by performing well. It is the ground you are meant to fight from.\n\n' +
  ...
  },
  {
    ...
    reflection:
      'When Jesus taught about purity, he did something that sounds harder, not easier. The old command was simple: do not commit adultery. Jesus said that entertaining the desire with your eyes and your mind is already the same offense on the inside, even if nothing ever happens outwardly. At first that feels like he just took an impossible standard and made it worse.\n\n' +
  ...
  },
  {
    ...
    reflection:
      'Paul gives the Corinthians a blunt instruction about sexual sin: get away from it, fast. Not negotiate with it, not see how close you can get, get out. In a city famous for sexual excess, he is not being prudish. He is being protective.\n\n' +
      'His reason is striking. He tells them their body is a dwelling place for God’s own Spirit, that they don’t belong only to themselves, that they were purchased at a real cost. This is not shaming the body as something dirty. It is the exact opposite. He is saying your body has enormous worth, it houses something sacred, and what you do with it matters because you matter. Getting out, then, is not fear and it is not self-hatred. It is treating something valuable like it is valuable.\n\n' +
      'Practically, getting out almost always means deciding before the moment, not in it. Very few people win this fight at the point of temptation. They win it earlier, in the quiet choices about what they watch, where they go, and what they keep on their phone at midnight. Taking the exit ramp seriously while you can still think clearly is wisdom, not weakness, and it flows from believing your body is worth protecting.',
  ...
  },
  {
    ...
    reflection:
      ...
      'He writes that whatever you’re up against is nothing unusual, nothing other people haven’t faced just as hard, and that God can be trusted to open a real way through it before it becomes too much to bear. Nothing unusual. You are not the exception, not uniquely broken. This is a shared human battle, which means you can stop carrying it like a freakish secret. And there is always a way out, provided by a faithful God, even when you cannot see it in the heat of the moment. Jesus adds the larger promise from John 8: the freedom he offers isn’t a partial, managed kind. It’s the real thing, start to finish.\n\n' +
  ...
  },
  {
    ...
    reflection:
      'Almost everything about this struggle thrives in the dark. Secrecy is not a side effect of it; secrecy is the soil it grows in. Which is exactly why James gives such a strange-sounding prescription: bring your failures into the open with someone else, and pray together over them, because that is part of how healing actually happens.\n\n' +
      'Notice he ties confession to healing, not only to forgiveness. First John already promises that owning your sin honestly with God is met with his faithfulness to forgive it completely. That vertical part is settled. But James adds a horizontal piece, confession to a trusted person, because what stays hidden stays powerful, and what is dragged into the light begins to lose its grip. This is not about public humiliation. It is about one or two safe people who know the real you and choose to stand with you anyway.\n\n' +
...
const FORGIVENESS_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'He writes that God is compassionate, patient, and overflowing with mercy toward him, that God hasn’t given him what his sins actually deserved, and that God has put an impossible distance between David and every wrong he has ever done, further apart than any two points could ever meet again. East and west never meet. There is no point on the map where they reconnect. That is the picture of how completely God has dealt with what you have done. Not filed away for later. Not held over your head. Removed.\n\n' +
  ...
  },
  {
    ...
    reflection:
      'People often wait to forgive until they feel like it. Paul writes as though forgiveness is a decision you make first, with the feelings following somewhere behind. He tells the Ephesians to get rid of bitterness, rage, and anger altogether, and instead to be kind and softhearted toward each other, quick to forgive.\n\n' +
      'Putting it away is the language of choice. You set bitterness down the way you set down a weight you have carried too long. And the standard he gives is not how you feel about the person, but how God has treated you: forgive the way God, because of what Christ did, has already forgiven you. Colossians says the same thing another way, putting up with each other and forgiving each other the way Christ forgave you. The measure is never how much the other person deserves it. It is how freely you yourself received it.\n\n' +
  ...
  },
  {
    ...
    reflection:
      'One reason people resist forgiveness is that they think it means pretending the wrong never happened, or staying in a place that keeps hurting them. Paul makes clear that is not what this is. He tells believers not to pay back evil with evil, and to step back and let God be the one who sets the score right, since real justice is his to deal out, not ours.\n\n' +
      ...
      'This is freeing, because the drive to make someone pay is exhausting, and it keeps you chained to the very person who hurt you. Paul ends by flipping the whole equation: don’t let evil win by dragging you down to its level, beat it instead by doing good, the picture of a person no longer controlled by the wound. Handing justice to God is not weakness and it is not denial. It is trusting that the One who sees it all will handle it better than your bitterness ever could.',
  ...
  },
  {
    ...
    reflection:
      'Jesus told a story about a son who took his inheritance, wasted it, hit rock bottom, and trudged home rehearsing an apology. He never gets to finish it. While the son was still a long way down the road, his father spotted him, took off running toward him, threw his arms around him, and kissed him.\n\n' +
...
const IDENTITY_WORTH_DAYS: DevotionalDay[] = [
  ...
  },
  {
    ...
    reflection:
      ...
      'He writes that God personally shaped him, piece by piece, while he was still forming in his mother’s womb, and his response is praise, not critique, because he was made with striking, deliberate care. He even says God saw him before he had any shape at all, and had already planned out his days before a single one of them arrived. The point is intention. You were not mass produced or thrown together. You were knit, on purpose, by Someone who knew exactly what he was doing and called the result wonderful.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'Anyone who belongs to Christ has become something genuinely new. The old identity is gone, replaced by something that did not exist before. New creation is strong language. It is not a renovation or a touch up on the old self. It is a genuinely new starting point. Your past is real, but in Christ it no longer gets to define you or set the ceiling on who you can become. The defining fact about you is no longer your worst chapter. It is your union with him.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'Paul writes that God chose us to belong to Christ before the world even existed, deciding in advance to bring us into his own family as children, fully accepted because of what Christ did. Peter uses similar language elsewhere, calling believers a people specifically chosen, set apart, and claimed as God’s own. Adoption is the key image. An adopted child is not chosen because they earned it or interviewed well. They are chosen on purpose, brought into a family, and given a name and a place that cannot be performed away. That is the language God uses for you.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'Paul writes that God proved his love in the clearest way possible: Christ died for us at the exact moment we least deserved it, while we were still living in open rebellion against him. At our worst. Not after we cleaned ourselves up, not once we proved we were worth it, but at our worst and least deserving. And in Galatians he says the life he now lives is lived entirely by trusting the Son of God, the one who loved him personally enough to give himself up for him. The love came first, before any performance, and it was deeply personal, for him, and for you.\n\n' +
...
const STRENGTH_DISCIPLINE_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'Hebrews says that no discipline feels good while it is happening, it feels painful, but afterward it produces a settled, right kind of life in the people who let themselves be shaped by it. Notice the word trained. The writer is using the picture of an athlete. The soreness, the resistance, the hard reps are not God being angry at you. They are the process by which something good grows in you. Discipline that feels like punishment in the moment is doing something redemptive underneath, the same way a hard workout breaks the body down so it can come back stronger.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He tells them to run to actually win, not just jog along, and points out that every serious athlete trains with real restraint, disciplined, because there is a prize on the line. Then he says he treats his own body firmly, keeping it under control rather than letting it call the shots. This is not him hating his body. It is him directing it, the way an athlete pays a real cost to compete well. The striking part is the contrast he draws. Athletes do all of this for a prize that fades, while believers train for one that lasts. He takes the discipline of the games and aims it at something eternal.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'God told him that the grace already given him was enough, and that God’s power actually reaches its fullest expression in weakness, not despite it. So Paul says he will gladly own his weaknesses instead of hiding them, so that Christ’s power can rest visibly on him, and he lands on a line that sounds backward: it is precisely in his weak moments that he finds himself strongest. The point is not that weakness is good in itself. It is that your limits are the exact place where God’s power has room to show up. As long as you run on pure self-reliance, you never get to find out what his strength actually feels like.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He says the eternal God never runs out of energy and never grows tired, and that he is the one who gives strength to people who have none left. Then comes the famous promise: those who put their hope in the Lord get their strength renewed, rising the way an eagle rises, able to run without wearing out and walk without giving up. The hinge word is wait. The renewal is not something you manufacture by grinding harder. It comes through dependence, through turning back to the source instead of squeezing the last drops out of yourself.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'Paul writes that whatever you do, you should throw yourself into it fully, as though you were doing it for the Lord and not merely for the people watching. Elsewhere he says the same idea applies to something as ordinary as eating or drinking, that even the small daily stuff can be done for God’s glory. That shift, doing it for the Lord instead of for an audience, changes the whole meaning of the work. The same workout, the same job, the same quiet faithfulness, done as an offering rather than a performance, becomes worship. Nothing about the effort itself changes. The audience does.\n\n' +
...
const ANXIETY_PEACE_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'He tells them to humble themselves under God’s strong hand, and to throw the whole weight of their worry onto him, because he genuinely cares about what happens to them. Two things stand out. First, the word cast, which means to throw, to actually hand it off, not to nervously hold it while asking God for help. Second, the reason given: because he cares for you. The invitation to let go is grounded in the truth that Someone bigger is paying attention and is genuinely concerned about your life.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He says don’t be anxious about anything, but in every situation, through prayer and specific requests offered with gratitude, bring what you need in front of God. And then the promise: a peace that stands guard over your heart and mind because of Christ Jesus, one that doesn’t even trace back to your circumstances actually improving. Notice the exchange. He does not say stop feeling anxious by sheer force of will. He says take the anxious thing and turn it into a prayer, with thanksgiving mixed in, and let God trade you a peace that does not even make logical sense given your circumstances.\n\n' +
      'That kind of peace, one that does not wait for your circumstances to make sense, is the key. This is not the peace of having everything figured out. It is a peace that shows up even when nothing is resolved, guarding your heart like a soldier at a gate. The path to it is not pretending you are fine. It is honestly handing God the specifics, with gratitude for what is already true, and letting him give what you cannot manufacture on your own.',
  ...
  },
  {
    ...
    reflection:
      ...
      'He points them to the birds overhead, who never plant a single seed or bring in a harvest, and yet their heavenly Father keeps them fed, and then asks whether they are not worth far more to God than any bird. He notes that worry cannot add a single hour to your life, and tells them to put God’s kingdom first, with the promise that everything else they actually need will follow. Then the famous landing: don’t spend today’s energy worrying about tomorrow, because tomorrow will bring its own worries when it gets here. Today already has enough to deal with on its own. He is not banning planning. He is confronting the way our minds borrow tomorrow’s troubles and pile them onto today.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He told them he was leaving them with his own peace, a peace that works nothing like the world’s version of it, and that their hearts did not need to be troubled or afraid. The world’s peace depends on circumstances cooperating, the bank account and the diagnosis and the relationship all going right, which means it evaporates the moment life gets hard. The peace Jesus gives is rooted in his presence rather than your situation, which is exactly why he could offer it on the worst night of his own life.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'God tells his people not to be afraid, because he is with them, not to be discouraged, because he is their God, and that he will personally strengthen them, help them, and hold them steady with his own capable hand. Read the promises slowly: I am with you, I will strengthen, I will help, I will hold you up. The antidote to fear here is not a guarantee of smooth circumstances. It is the nearness of God himself. The reason not to be afraid is simply that you are not facing it alone.\n\n' +
...
const RUNNING_THE_RACE_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'His first instruction is to strip off every extra weight, along with the sin that so easily trips us up, and to run the specific race marked out for us with real endurance. Notice the two different things he names. There is sin, the obvious thing, but there is also weight, which may not be sinful at all, just extra that slows you down. A runner strips off anything that does not help, even good things, when they become dead weight. And then the key idea: endurance. This is not a sprint.\n\n' +
      'Then comes the secret to not quitting: keeping your eyes fixed on Jesus, the one who both started and will complete your faith. A runner who stares at the competition or at their own burning legs falls apart. A runner fixed on the finish keeps going. Whatever is weighing you down right now, some of it you were never meant to carry into this race. The real questions are what you need to set down, and where your eyes are actually fixed.',
  ...
  },
  {
    ...
    reflection:
      ...
      'This one thing: he lets go of what is behind him and stretches forward toward what is ahead, pushing toward the goal and the prize God is calling him toward in Christ Jesus. Forgetting here does not mean pretending the past never happened. It means refusing to let it set the pace for your present. Both regret over old failures and pride over old wins can keep you running in place. Paul lets go of the rearview so he can lean into what is ahead.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He writes that we should not get worn down doing what is right, because there is a harvest coming at the right time, as long as we do not give up before it arrives. Two ideas carry the whole verse. The timing of the harvest, which is not yours to set, and is often later than you would like. And the real danger, which is quitting right before the payoff. He is not promising instant results. He is promising that faithfulness is never finally wasted.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He writes that he has fought hard, finished what he set out to do, and stayed faithful the whole way through. Then he looks ahead to a reward waiting for him for having lived rightly, and adds that it is not only for him, but for everyone who longs for Christ’s return. Notice he does not say I won every battle or I never stumbled. He says I finished and I kept the faith. The goal of the race was never a flawless run. It was crossing the line still trusting, still holding on.\n\n' +
...
const STEWARDING_BODY_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'He pleads with believers to offer their bodies as a living sacrifice, set apart and pleasing to God, which he calls the only reasonable response to what God has done. Stop and notice that. He frames it as worship, and he is talking about your body. Not just your prayers or your songs, but your physical self, offered to God. The way you treat your body is not separate from your faith; it is one of the most concrete forms your worship takes.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He says that physical training has a real but limited benefit, while growing in godliness benefits you in every way, both in this life and in the one to come. Read carefully. He does not say bodily exercise is worthless; the sense is that its benefit is real but temporary, good for now but not forever. Training the body has real value. It is just not the highest value, and it does not last forever. Godliness, growing in Christ, pays off in this life and the next. Paul is drawing a line of proportion, not throwing out the body.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He resolved inwardly that he would not compromise, and asked to eat plain food and water instead, as a ten-day test. By the end, he looked noticeably healthier than everyone else. The point is not a diet plan; it is a heart posture. Daniel treated even his eating as a place to honor God and keep his integrity, in a culture that offered him every excuse not to. He took seriously something many of us treat as automatic.\n\n' +
...
const GRIEF_COMFORT_DAYS: DevotionalDay[] = [
  ...
  },
  {
    ...
    reflection:
      ...
      'Blessed are those who mourn, because comfort is coming to them. He does not say blessed are those who never grieve, or those who get over it fastest. He blesses the ones who mourn, and he attaches a promise to it: they shall be comforted. Mourning, in Jesus’ eyes, is not weakness or faithlessness. It is an honest response to a broken world, and it is the very thing that opens us to receive God’s comfort. You cannot be comforted in a sorrow you refuse to feel.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He calls God the source of all mercy and all comfort, the one who comforts us in every hardship we face so that we, in turn, can offer that same comfort to anyone else going through something hard, passing along the exact comfort we ourselves received. Read that chain slowly. God comforts you in your trouble. And the comfort he gives is not only for you; it equips you to one day sit with someone else in theirs, with a tenderness you could only have learned in your own valley. Nothing about your grief is finally wasted in his hands.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He hears that God himself will wipe every tear from their eyes, and that death, grief, crying, and pain will all be gone completely, because the old order of things will have passed away. Notice how personal it is: God himself wipes away the tears, the way a parent gently does for a child. And notice what is promised, not a world where you have learned to live with death, but a world where death itself is gone. This is the hope that lets believers grieve honestly without grieving like people who have nothing beyond this life to hope for.\n\n' +
...
const TRUSTING_UNCERTAINTY_DAYS: DevotionalDay[] = [
  ...
  },
  {
    ...
    reflection:
      ...
      'It is only because of the Lord’s mercy that we have not been overwhelmed completely, because his compassion never runs dry. It is renewed every single morning, and his faithfulness is enormous. Catch the setting. This is not denial of the hardship; the writer has named the pain in full. It is a choice to anchor to God’s faithfulness in spite of it. The mercies are new every morning, which means however dark today was, tomorrow comes with a fresh supply. You do not have to store up enough strength for the whole uncertain road. You only need today’s mercy, and it is renewed daily.\n\n' +
...
const NEW_BEGINNINGS_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'Stop dwelling on the former things, God says, do not keep replaying what has already happened. I am doing something new, and it is already starting to break through, can you not see it? I am making a way through the wilderness itself, rivers in the middle of the desert. Notice the urgency. It is already breaking through, not someday. God is not only able to do new things; he specializes in them, and in the least likely places, a road through wilderness, water in a desert. The call to not dwell on the former things is not denial; it is an invitation to stop assuming the past defines what God can do next.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'He says God lifted him up out of a horrible pit, out of the thick mud that trapped him, and set his feet on solid rock, steadying every step. And God put a brand new song in his mouth. Trace the movement. From a pit, from clay that grips and holds you down, to a rock, to steady footing, to a new song. David did not climb out by his own strength; he says God brought him up. And the result was not just rescue but a fresh voice, a new song he could not have sung from the bottom.\n\n' +
  ...
  },
  {
    ...
    reflection:
      ...
      'The one seated on the throne says it plainly: I am making everything new. Notice it is not he made some things new once, long ago, but he makes all things new, an ongoing, comprehensive renewal that reaches its climax at the end of the story. The same God who renews hearts and lifts people out of pits is the God who will one day make the entire creation new. Your personal new beginnings are not random; they flow from the character of a God who is always renewing.\n\n' +
...
const WORD_ALONE_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'God has said plainly: I will never leave you, and I will never abandon you. Look at how absolute it is. Not I will rarely leave you, or I will be there if you perform well, but never leave, never abandon. This is God’s own word about his presence, and it does not depend on how you feel, whether anyone else shows up, or how alone your circumstances look. His presence is a fact rooted in his promise, not in your emotions.\n\n' +
...
const WORD_AFRAID_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'God did not give us a spirit that cowers in fear, but one marked by power, love, and a clear, steady mind. Notice he names what the fear is not: it is not from God. And he names what God has actually given instead, three things: power, love, and a clear, level head, steady rather than spinning and panicked. This does not shame you for feeling afraid; everyone does. It reminds you that fear does not get to be the loudest or final voice, because God has put something stronger in you.\n\n' +
      'When fear is gripping you, this verse is something to hold onto and even say back to it: this spirit of fear is not from God, and he has given me power, love, and a clear mind instead. You do not have to manufacture courage out of nowhere; you ask God to stir up what he has already placed in you. The fear may not vanish instantly, but it does not get the throne. There is a steadier spirit available to you right now than the fearful one.',
...
const WORD_WAITING_DAYS: DevotionalDay[] = [
  {
    ...
    reflection:
      ...
      'Wait for the Lord, and take courage while you do, because he will strengthen your heart. Wait, David says again, for the Lord. Notice he says wait twice, bookending the verse, as if he knows how badly we need to hear it again. And notice waiting here is not passive collapse; it takes real courage to hold steady. There is a promise tucked in the middle: he will strengthen your heart. The waiting itself becomes a place where God does something in you, strengthening the very heart that feels worn thin by the delay.\n\n' +
