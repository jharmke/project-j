...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: {
          discipline: '17 data types across 4 categories: Nutrition (calories, macros, fiber, sodium), Activity (steps, active cals, effort), Body (weight), Sleep & Recovery (score, hours, stages).',
