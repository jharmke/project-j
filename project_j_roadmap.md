...
- [ ] QUICK WINS (small, grab-when-convenient): notification modal solo (non-stacked) cards get shadows · EvR saved-reports history list getting long -> consolidate/collapse/archive · Day Summaries grouped by week is 9 weeks and growing -> after N weeks group Month -> Week (open to other ideas). (DONE: animate Otto chat bubbles -- shipped in the Otto chat aesthetic pass.)
