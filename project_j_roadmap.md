...
- [surfaced 2026-07-19, FULLY LOCKED 2026-07-21, ready to build] **Scan a nutrition facts panel to autofill
  ...
  STILL OPEN on this feature: the container row can't be built from a volume-only serving with no gram
  equivalent, no scan entry point in the barcode flow, bilingual labels, and the temp "OCR Test" row in
  Settings dev tools. (Otto's KB covers label scanning as of 2026-07-22; the TUTORIAL pass is still open.
  Dual-column parsing SHIPPED 2026-07-22, see RECENTLY SHIPPED.)
