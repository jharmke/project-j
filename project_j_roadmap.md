...
- OPEN: Trend chart bottom stat labels -- visual treatment too plain, wording needs work. Consider hairline divider above, two lines with size hierarchy, wording reframe (lead with context not number). Discuss with Justin before touching.
