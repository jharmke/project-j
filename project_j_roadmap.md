...
[ ] Default Warm accent (Amber) -- revisit whether it should change after the sepia/gradient fix lands. Parked until Warm gradient resolved.
[ ] Blush default accent -> Lipstick (currently Rose, too pink for a default). Swap the id:'default' row to Lipstick #cc1144, keep ids stable, verify saved selectedAccent doesn't shift for existing Blush users. theme.tsx.
