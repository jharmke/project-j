...
[ ] Achievements audit -- IN PROGRESS. Hydration category complete (8 achievements: First Sip/Hydrated/Bathtub/Half Century/Relentless/Swimming Pool/High Tide/Ol' Reliable, 1-10-30-50-75-100-200-365 days). Steps, weight, streak, faith, general, and new categories (workout, sleep, nutrition) still needed. Bug fixed: hydration_30/100 triggers were missing from both index.tsx and log.tsx -- all 8 now wired. criteria field added to AchievementDef -- plain factual requirement shown on every card (locked and unlocked) above the fun description. All 20 existing achievements populated.
