...
OPEN: Edit food modal -- Brand name field missing entirely. Saturated Fat is full-width (should be half-width, paired with Brand or a spacer). Both files need update. Next session.
