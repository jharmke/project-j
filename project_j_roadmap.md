...
- [x] SHIPPED Fitness Metrics card expanded to 6 metrics -- VO2 Max, Cardio Recovery, Resting HR, Resp. Rate, Blood O2, Body Fat. 3-column flexWrap layout, 22px Bebas values, micro-disclaimer at bottom. exerciseMinutes deferred (placement TBD).
