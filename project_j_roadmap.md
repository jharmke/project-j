...
- [surfaced 2026-07-19, FULLY LOCKED 2026-07-21, ready to build] **Scan a nutrition facts panel to autofill
  ...
  STILL OPEN on this feature: the TUTORIAL pass (Otto's KB covers label scanning as of 2026-07-22, the
  tutorials still say nothing). Everything else on the old open list is DONE or was already done and the
