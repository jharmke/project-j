...
[ ] Achievements audit -- IN PROGRESS. Status per category:
  ...
  General: 3 achievements (Day One, First Word, Consistent Voice). First Word + Consistent Voice count personal/fitness journal entries only (gratitude moved to faith, workout was dead code -- both removed from GENERAL_JOURNAL_CATS). Trigger wired in journal.tsx createEntry. NEEDS EXPANSION PASS next general session -- add journal milestones (25/50/100/365), Days in App milestones, any other general firsts.
