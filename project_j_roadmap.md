...
- 2026-07-05 EvR saved-reports list cleanup (quick win): the SAVED REPORTS list on the Effort vs Results screen rendered all up-to-15 reports as full rows (long scroll). Now shows the current + 3 recent, older ones collapse behind a "Show N older" / "Show less" toggle. Storage was already capped at 15; this is display-only. Pure JS.
