...
- [ ] QUICK WINS (small, grab-when-convenient): EvR saved-reports history list getting long -> consolidate/collapse/archive (open to other ideas). (DONE this session: animate Otto chat bubbles · notification solo-card shadows · Day Summaries month-grouping.)
