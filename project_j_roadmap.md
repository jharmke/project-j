...
[x] TestFlight -- LIVE 2026-05-22. Internal build installed and verified. External review submitted Friday 5/22, expected Monday 5/25. App Store Connect record created as "Project J Wellness" (placeholder -- rename before App Store submission). EAS production build 1.0.0 (build 6). Google API key rotated + old key deleted. GoogleService-Info.plist updated with new key. Privacy/terms live at projectj-5d024.web.app. Friends/family invites pending external review.
