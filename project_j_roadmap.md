...
SOON -- confirmed next few sessions
  ...
  [ ] CHORE: Net carbs copy audit -- the macros card tutorial + tooltip were already updated for net carbs (SHIPPED 2026-05-27). Audit the REMAINING carb mentions for net-carbs consistency: Advanced Nutrition tooltip, Day Score nutrition copy, day-detail, and any other place carbs are explained. (SOON)
