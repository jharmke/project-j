...
SOON -- confirmed next few sessions
  ...
  [ ] FEATURE: Advanced Nutrition drill-down -- tap a nutrient title to see a breakdown of which logged foods contributed to that total (list of all, or the highest contributors). Log tab > Advanced Nutrition. (SOON)
  ...
  [~] Day Score + Day Summary -- SESSION 65 UPDATE (2026-05-31). Engine + pop-up + archive were already shipped across ~17 prior commits (line above was never marked). This session added the FULL SUMMARY PAGE and fixed a real exclusion bug:
        ...
        STILL TO DO (next session): (2) Mindful copy/behavior pass for the full page. (3) delete the now-dead archiveSummary DaySummaryModal render + state in stats.tsx (archive routes to the page now). (SOON)
