...
[ ] Step goal trigger race condition -- cannot test directly (requires cold launch on the exact moment steps cross goal for first time that day). Code fix confirmed in place, leaving as untestable in current state. index.tsx.
