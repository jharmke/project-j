...
SOON -- confirmed next few sessions
  ...
  [ ] BUG: Gear icons inconsistent across the app -- some clear/unstyled, some accent-colored, some theme-colored. Do a consistency pass so all gear icons follow one rule. (SOON)
