...
- **Otto's workout builder (THE PLAN item E): `SPEC_workout_builder.md`** -- written 2026-08-10, nothing built,
  blocked on item J. Status lives in `PLAN.md` item E; that file holds the design, the open items and 5 traps.
  (Open items 1 and 2 closed; the preview card is fully designed as of 2026-08-11. 7 open, program card next.)
