...
[ ] 4. Camera permission string + remove NSHealthUpdateUsageDescription (write permission confirmed unused) + iPad supportsTablet: false -- one commit, one new build. Reproductive health HealthKit types already removed (JS-only, done).
